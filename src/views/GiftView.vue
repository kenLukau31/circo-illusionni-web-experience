    ...
    <div class="product">
      ...
      <div class="product-details">
        ...
        <div class="product-details-buy-section">
          ...
          <button id="add-product" @click="addProduct">
...
export default {
  ...
  mounted() {
     ...
     */
    this.productName = this.productStore.products.find(
      (product) => product.id == this.$route.params.id,
    ).name;
    this.productDesc = this.productStore.products.find(
      (product) => product.id == this.$route.params.id,
    ).description;
    this.productImage = this.productStore.products.find(
      (product) => product.id == this.$route.params.id,
    ).image;
    this.productPrice = this.productStore.products.find(
      (product) => product.id == this.$route.params.id,
    ).price;
    this.productDiscount = this.productStore.products.find(
      (product) => product.id == this.$route.params.id,
    ).discount;
    this.productExclusivity = this.productStore.products.find(
      (product) => product.id == this.$route.params.id,
    ).exclusive;
  },
