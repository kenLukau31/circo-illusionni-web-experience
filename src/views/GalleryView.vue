<template>
  <section class="main-section-gallery" style="margin-left: 60px">
    <div class="section-texts">
      ...
      <p class="section-desc">
        Um espetáculo em imagens onde cada foto é uma acrobacia, <br />e cada
        momento, único.
      </p>
    </div>
  ...
  <section class="section" style="margin-left: 60px; margin-right: 60px">
    <div class="graphic-el-gallery">
      ...
      >
        <path
          d="M72.4946 46.3968C300.743 -69.6917 560.133 56.0629 661.899 184.718C661.899 184.718 867.158 447.831 562.711 681.194C258.264 914.556 -12.3731 796.479 -108.744 547.048C-183.682 353.088 -155.754 162.485 72.4946 46.3968Z"
          fill="#E4CB66"
        />
      </svg>
    </div>
    <button class="btn-red" @click="verifyAutentication">Partilhar</button>
    ...
    <div class="gallery-section-container">
      <div class="gallery-img-container">
        <v-row dense>
          ...
          <v-col v-for="photo in photos" :key="photo.id" cols="4">
            <div class="post-container">
              <v-img
                :src="photo.src.original || photo.urls.full"
                alt="Imagem"
                class="align-end gallery-img-card ma-2"
                :aspectRatio="1.5"
                cover
      ...
      <button class="btn-red" @click="loadPhotos">+</button>
    </div>

    <div v-if="alertVisible" class="personalizedAlert">
      <div class="cont-personalizedAlert">
        <img
          src="@/assets/alerts/error-msg.png"
          alt=""
          class="img-personalizedAlert"
        />
        <button @click="closePersonalizedAlert" class="btn-personalizedAlert">
          X
        </button>
      </div>
    </div>
